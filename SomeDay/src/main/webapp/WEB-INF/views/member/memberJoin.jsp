...
<form:form commandName="member" action="memberEnd" method="post" name="joinform" >
...
<th scope="row">비밀번호</th>
                <td>
                <form:input type="pass" class="txt w200" path="pass" onclick="this.value=''"/>
...
<th scope="row">주소</th>
                <td>
                    ...
                    <form:input type="text" class="inputTypeText" path="addr1" onclick="this.value=''" id="addr1" readonly="true" />
