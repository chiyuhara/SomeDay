...
<script type="text/javascript">
	function memberDeleteChk(){
		if(document.memberDeleteform.pass.value == ""){
			alert("비밀번호를 입력하세요.");
			document.memberDeleteform.pass.focus();
			return false;
		}
		return true;;
	}
		...
		<tr>
			...
			<font size ="2">* 회원 탈퇴를 하시면 회원 정보와 개인 정보가 삭제되며 <br>&nbsp;&nbsp;데이터는 영원히 복구 되지 않습니다.</font><br>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="pass" class="txt w220" name="pass" /></td>
				...
				<div class="btn_type_04">
					<a href="/someday/" class="btn btnC_03 btnF_02 mr10">
						<span>취소</span>
					</a>
