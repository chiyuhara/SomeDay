...
.faa-wrench.animated.faa-fast, .faa-wrench.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-wrench.faa-fast {
	animation: wrench 1.2s ease infinite;
}

.faa-wrench.animated.faa-slow, .faa-wrench.animated-hover.faa-slow:hover,
...
.faa-ring.animated.faa-fast, .faa-ring.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-ring.faa-fast {
	animation: ring 1s ease infinite;
}

.faa-ring.animated.faa-slow, .faa-ring.animated-hover.faa-slow:hover,
...
.faa-vertical.animated.faa-fast, .faa-vertical.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-vertical.faa-fast {
	animation: vertical 1s ease infinite;
}

.faa-vertical.animated.faa-slow, .faa-vertical.animated-hover.faa-slow:hover,
...
.faa-horizontal.animated.faa-fast, .faa-horizontal.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-horizontal.faa-fast {
	animation: horizontal 1s ease infinite;
}

.faa-horizontal.animated.faa-slow, .faa-horizontal.animated-hover.faa-slow:hover,
...
.faa-flash.animated.faa-fast, .faa-flash.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-flash.faa-fast {
	animation: flash 1s ease infinite;
}

.faa-flash.animated.faa-slow, .faa-flash.animated-hover.faa-slow:hover,
...
/* BOUNCE */
@
keyframes bounce { 0%,10%,20%,50%,80%,100%{
...
.faa-bounce.animated.faa-fast, .faa-bounce.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-bounce.faa-fast {
	animation: bounce 1s ease infinite;
}

.faa-bounce.animated.faa-slow, .faa-bounce.animated-hover.faa-slow:hover,
...
.faa-spin.animated.faa-fast, .faa-spin.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-spin.faa-fast {
	animation: spin 0.7s linear infinite;
}

.faa-spin.animated.faa-slow, .faa-spin.animated-hover.faa-slow:hover,
...
.faa-float.animated.faa-fast, .faa-float.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-float.faa-fast {
	animation: float 1s linear infinite;
}

.faa-float.animated.faa-slow, .faa-float.animated-hover.faa-slow:hover,
...
.faa-pulse.animated.faa-fast, .faa-pulse.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-pulse.faa-fast {
	animation: pulse 1s linear infinite;
}

.faa-pulse.animated.faa-slow, .faa-pulse.animated-hover.faa-slow:hover,
...
.faa-shake.animated.faa-fast, .faa-shake.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-shake.faa-fast {
	animation: wrench 1.2s ease infinite;
}

.faa-shake.animated.faa-slow, .faa-shake.animated-hover.faa-slow:hover,
...
.faa-tada.animated.faa-fast, .faa-tada.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-tada.faa-fast {
	animation: tada 1s linear infinite;
}

.faa-tada.animated.faa-slow, .faa-tada.animated-hover.faa-slow:hover,
...
.faa-passing.animated.faa-fast, .faa-passing.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-passing.faa-fast {
	animation: passing 1s linear infinite;
}

.faa-passing.animated.faa-slow, .faa-passing.animated-hover.faa-slow:hover,
...
.faa-passing-reverse.animated.faa-fast, .faa-passing-reverse.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-passing-reverse.faa-fast {
	animation: passing-reverse 1s linear infinite;
}

.faa-passing-reverse.animated.faa-slow, .faa-passing-reverse.animated-hover.faa-slow:hover,
...
.faa-burst.animated.faa-fast, .faa-burst.animated-hover.faa-fast:hover,
	.faa-parent.animated-hover:hover>.faa-burst.faa-fast {
	animation: burst 1s infinite linear
}

.faa-burst.animated.faa-slow, .faa-burst.animated-hover.faa-slow:hover,
				...
				<div class="box">
							...
							<div class="pop-container">
								<div class="pop-conts">
									...
									<div class="span4 well">
										<form:form accept-charset="UTF-8" action="Message"
											method="post">
											<textarea
												style="width: 100%; height: 100; border: 1; overflow: visible; text-overflow: ellipsis;"
												id="new_message" name="message"
												placeholder="상대방에게 어필해보세요!(쪽지는 한번밖에 보낼 수 없습니다.)" rows="5"></textarea>
											<div style="float: right" class="btn-r">
						...
						<div id="message2" class="pop-message2">
							<div class="pop-container2">
								<div class="pop-conts2">
									...
									<c:choose>
										<c:when test="${targetmale != null}">
											<td>${targetfemale.female_msg}</td>
										</c:when>
										<c:when test="${targetfemale != null}">
											<td>${targetfemale.male_msg}</td>
										</c:when>
									</c:choose>
					...
					<c:choose>
						<c:when test="${targetfemale.score == 0}">
							<form:form id="form1" name="form1" action="Score"
								commandName="todayModel" method="post">
														...
														type="radio" name="star-input" id="p5" value="5"><label
															...
															id="p6" value="6"><label for="p6">6</label> <input
																type="radio" name="star-input" id="p7" value="7"><label
																	...
																	name="star-input" id="p8" value="8"><label
																		for="p8">8</label> <input type="radio"
																		name="star-input" id="p9" value="9"><label
																			for="p9">9</label> <input type="radio"
																			name="star-input" id="p10" value="10"><label
																				for="p10">10</label></span> <output for="star-input">
									<b id="output">0</b>점</output>
								</span>
							</form:form>
						</c:when>
						<c:when test="${targetfemale.score == 1}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p1">1</label></span>
						...
						<c:when test="${targetfemale.score == 2}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p2">2</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 3}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p3">3</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 4}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p4">4</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 5}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p5">5</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 6}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p6">6</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 7}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p7">7</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 8}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p8">8</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 9}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p9">9</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
						<c:when test="${targetfemale.score == 10}">
							<span class="star-input"> <span class="input"> <input
									...
									checked="checked"><label for="p10">10</label></span>
								<td>${targetfemale.score}점</td>
							</span>
						</c:when>
					</c:choose>
					...
					<form:form name="form2" commandName="todayModel" action="Like"
						...
						<br></br>
						<div>
							<button type="button" onclick="return button_event();"
								...
								<c:when test="${targetfemale != null}">
									<c:choose>
										<c:when test="${targetfemale.female_msg == null}">
											<button type="button" onclick="button_message('message');"
