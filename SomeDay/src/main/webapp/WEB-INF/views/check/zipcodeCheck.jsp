...
<script language="JavaScript">
   ...
   function sendAddress(zipcode,area1,area2,area3,area4){
      var address = area2+" "+area3+" "+area4;
      opener.document.join.zipcode.value=zipcode;
      opener.document.join.area.value=area1;
      opener.document.join.addr1.value=address;
      opener.document.join.addr2.focus();
      self.close();
   }
</script>
</head>
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="zipForm.text.focus()">
    <form name="zipForm" method="post" action="zipcodeCheck">
