...
public class MemberController {
   ...
   //유효성검사했을때 에러있을시 넘어가게끔 해줘야함
      ...
      @RequestMapping("/member/memberEnd")
      public ModelAndView memberStep3(@ModelAttribute("member") MemberModel member,
         ...
         try {
            // 유효성검사에 통과하면 회원가입
        	member.setAddr1(member.getAddr1()+" " + member.getAddr2());
      ...
      @RequestMapping(value="/member/zipcodeCheckForm")
      ...
      //회원가입시 우편번호 검색 로직 
      @RequestMapping(value="/member/zipcodeCheck")
