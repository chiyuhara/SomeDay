...
public class TodayService implements TodayDao {
	...
	// 여자가 남자에게 별점을 보냄
	@Override
	public int female_score(TodayModel todayModel) {
		return sqlSessionTemplate.update("today.female_score", todayModel);
	}

	// 남자가 여자에게 별점을 보냄
	@Override
	public int male_score(TodayModel todayModel) {
		return sqlSessionTemplate.update("today.male_score", todayModel);
	}

	// 여자가 남자에게 메시지를 보냄
	@Override
	public int female_message(TodayModel todayModel) {
		return sqlSessionTemplate.update("today.female_message", todayModel);
	}

	// 여자가 남자에게 메시지를 보냄
	@Override
	public int male_message(TodayModel todayModel) {
		return sqlSessionTemplate.update("today.male_message", todayModel);
	}
